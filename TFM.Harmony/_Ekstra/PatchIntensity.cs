...
//					__result = 999; // Increased from 80
//					break;
//				case PatchIntensity.Normal:
//					__result = 999; // Increased from 100
//					break;
//				case PatchIntensity.Strong:
//					__result = 999; // Increased from 130
//					break;
//				default:
//					__result = 0;
//					break;
...
//			{
//				case PatchIntensity.Weak:
//					__result = 99; // Increased from 8
//					break;
//				case PatchIntensity.Normal:
//					__result = 99; // Increased from 11
//					break;
//				case PatchIntensity.Strong:
//					__result = 99; // Increased from 16
//					break;
//				default:
//					__result = 0;
//					break;
...
//			{
//				case PatchIntensity.Weak:
//					__result = 900; // Increased from 300
//					break;
//				case PatchIntensity.Normal:
//					__result = 900; // Increased from 400
//					break;
//				case PatchIntensity.Strong:
//					__result = 900; // Increased from 550
//					break;
//				default:
//					__result = 0;
//					break;
...
//			{
//				case PatchIntensity.Weak:
//					__result = 99; // Increased from 12
//					break;
//				case PatchIntensity.Normal:
//					__result = 99; // Increased from 15
//					break;
//				case PatchIntensity.Strong:
//					__result = 99; // Increased from 18
//					break;
//				default:
//					__result = 0;
//					break;
...
//			{
//				case PatchIntensity.Weak:
//					__result = 99; // Increased from 4
//					break;
//				case PatchIntensity.Normal:
//					__result = 99; // Increased from 6
//					break;
//				case PatchIntensity.Strong:
//					__result = 99; // Increased from 9
//					break;
//				default:
//					__result = 0;
//					break;
